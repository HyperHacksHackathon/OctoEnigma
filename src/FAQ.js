        ...
        <div id="carouselExampleIndicators" class="carousel slide mt-5" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class={"carousel-item" + (currentSlide == 0 ? 'active' : '')}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="891.012" height="535.179" viewBox="0 0 891.012 535.179">
                    <g id="Group_18" data-name="Group 18" transform="translate(-179.488 -1586.266)">
                        ...
                        <text id="Lots" transform="translate(213 1723)" fill="#fff" font-size="32" font-family="IBMPlexSans-Text, IBM Plex Sans"><tspan x="0" y="0">Blah blah blah blah blah</tspan></text>
                    </g>
                    </svg>
                </div>
                <div class={"carousel-item" + (currentSlide == 1 ? 'active' : '')}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="891.012" height="535.179" viewBox="0 0 891.012 535.179">
                        <g id="Group_18" data-name="Group 18" transform="translate(-179.488 -1586.266)">
                            ...
                            <text id="Lots" transform="translate(213 1723)" fill="#fff" font-size="32" font-family="IBMPlexSans-Text, IBM Plex Sans"><tspan x="0" y="0">Hoomans</tspan></text>
                        </g>
                    </svg>
                </div>
                <div class={"carousel-item" + (currentSlide == 2 ? 'active' : '')}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="891.012" height="535.179" viewBox="0 0 891.012 535.179">
                        <g id="Group_18" data-name="Group 18" transform="translate(-179.488 -1586.266)">
                            ...
                            <text id="Lots" transform="translate(213 1723)" fill="#fff" font-size="32" font-family="IBMPlexSans-Text, IBM Plex Sans"><tspan x="0" y="0">Discord</tspan></text>
                        </g>
                    </svg>
                </div>
            </div>
            <a class="carousel-control-prev" role="button" data-slide="prev" onClick={() => setSlide(currentSlide - 1)} style={{
                ...
                <span class="sr-only" selectable='false'>Previous</span>
            </a>
            <a class="carousel-control-next" role="button" data-slide="next" onClick={() => setSlide(currentSlide + 1)} style={{
                ...
                <span class="sr-only" selectable='false'>Next</span>
            </a>
        </div>
    </div>
    );
