  ...
  return (
    <div className='zh'>
        <BasicNav style={{
            ...
            left: '-45vw'
        }} scrollPosition={props.scrollPosition}></BasicNav>
...
function BasicNav(props) {
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="2740.179" height="280.331" viewBox="0 0 2740.179 280.331" className='bar' style={props.style}>
            <defs>
            ...
            <g id="Group_16" data-name="Group 16" transform="translate(126 -1066.384)">
                ...
                <a href='#ABOUTMARK'>
                <path id="Path_13" data-name="Path 13" d="M2787.822,4491.669l-27.361-27.361v-37.441h272.977v64.8Z" transform="translate(-1940 -3207)" stroke="#fff" strokeWidth="10" fill={aboutHoverState ? 'white' : 'black'}
                ...
                <a href='#FAQMARK'>
                <path id="Path_14" data-name="Path 14" d="M2760.461,4491.669v-64.8h313v64.8Z" transform="translate(-1667.023 -3207)" stroke="#fff" strokeWidth="10" fill={faqHoverState ? 'white' : 'black'}
                ...
                <a href='#ABOUTMARK'>
                <text id="ABOUT" transform="translate(927.146 1265.937)" fill={aboutHoverState ? 'black' : 'white'} font-size="35" font-family="ibm-plex-sans, sans-serif" font-weight="700"
                    onMouseEnter={() => setAboutHoverState(true)}
                    onMouseLeave={() => setAboutHoverState(false)}
                ><tspan x="-18" y="0" clickable="false">About</tspan></text></a>
                <a href='#FAQMARK'>
                <text id="About" transform="translate(1201.236 1265.937)" fill={faqHoverState ? 'black' : 'white'} font-size="35" font-family="ibm-plex-sans, sans-serif" font-weight="700"
                    onMouseEnter={() => setFAQHoverState(true)}
                    onMouseLeave={() => setFAQHoverState(false)}
                ><tspan x="15" y="0" clickable="false">FAQ</tspan></text></a>
                <a href='#SPONSORSMARK'>
